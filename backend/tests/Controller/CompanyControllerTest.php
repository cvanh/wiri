...
final class CompanyControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            'company[longitude]' => 'Testing',
            'company[latitude]' => 'Testing',
            'company[name]' => 'Testing',
            'company[about]' => 'Testing',
            'company[type]' => 'Testing',
        ]);
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            'company[longitude]' => 'Something New',
            'company[latitude]' => 'Something New',
            'company[name]' => 'Something New',
            'company[about]' => 'Something New',
            'company[type]' => 'Something New',
        ]);
